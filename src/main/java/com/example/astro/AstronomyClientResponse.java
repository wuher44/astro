...
public class AstronomyClientResponse {
    ...
    public AstronomyClientResponse(@JsonProperty("location")Location location, @JsonProperty("sunrise") String sunrise, @JsonProperty("sunset") String sunset,
